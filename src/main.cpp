...
ArSlot_t slot_MyApp_on_open()
{
	...
	*/
	CLI::Log(CLI::Debug, "creating a string and output it...");
	...
	CLI::Log(CLI::Debug, "done.");
	CLI::Log(CLI::Debug, "creating a wide string and output it...");
	...
	*/
	CLI::Log(CLI::Debug, "creating a string by copy and output it...");
	String World = " World!";
	String CpWorld(World);
	CLI::Output << CpWorld << CLI::EndLine;
	CLI::Output << CpWorld.length() << CLI::EndLine;
	CLI::Log(CLI::Debug, "done.");
	CLI::Log(CLI::Debug, "creating a wide string by copy and output it...");
	...
	*/
	CLI::Log(CLI::Debug, "creating two strings, try to contatenate them with operator+ and output the result...");
	String Hello = "Hello,";
	CLI::Log(CLI::Debug, "concatenation process...");
	String HelloWorld = Hello + World;
	CLI::Output << HelloWorld << CLI::EndLine;
	CLI::Output << HelloWorld.length() << CLI::EndLine;
	CLI::Log(CLI::Debug, "done.");
	CLI::Log(CLI::Debug, "creating two wide strings, try to contatenate them with operator+ and output the result...");
	...
	*/
	CLI::Log(CLI::Debug, "creating a string and try to use +=operator with a char pointer and output the result...");
	...
	*/
	CLI::Log(CLI::Debug, "creating a string and try to use +=operator with another string and output the result...");
	...
	CLI::Log(CLI::Debug, "creating two strings and try to use conditional ==operator with another string and output the result...");
	...
	CLI::Log(CLI::Information, "the result need to be true");
	CLI::Output << checkEq << CLI::EndLine;
	CLI::Log(CLI::Debug, "try to use conditional !=operator and output the result...");
	checkEq = Check1Eq != Check2Eq;
	CLI::Log(CLI::Information, "the result need to be false");
	CLI::Output << checkEq << CLI::EndLine;
	CLI::Log(CLI::Debug, "done.");

	CLI::Log(CLI::Debug, "try to find a string inside an another string");
	...
	CLI::Log(CLI::Debug, "try to find an array of chars inside a string");
	String findStr2 = "World Hello!";
	CLI::Log(CLI::Information, "the result need to be 6");
	CLI::Output << findStr2.find("Hello", 0) << CLI::EndLine;

	CLI::Log(CLI::Debug, "try to find an array of chars inside a string with a specific counter");
	...
	CLI::Log(CLI::Debug, "testing operator>> and output the input...");
	CLI::Log(CLI::Information, "You need to input something in the shell...");
	String inputstr;
	CLI::Input >> inputstr;
	CLI::Log(CLI::Debug, "reading input...");
