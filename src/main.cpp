...
afwslot slot_MyApp_on_open()
{
	...
	*/
	AuroraFW::Debug::Log("creating a string and output it...");
	...
	AuroraFW::Debug::Log("done.");
	AuroraFW::Debug::Log("creating a wide string and output it...");
	...
	*/
	AuroraFW::Debug::Log("creating a string by copy and output it...");
	String World = " World!";
	String CpWorld(World);
	CLI::Output << CpWorld << CLI::EndLine;
	CLI::Output << CpWorld.length() << CLI::EndLine;
	AuroraFW::Debug::Log("done.");
	AuroraFW::Debug::Log("creating a wide string by copy and output it...");
	...
	*/
	AuroraFW::Debug::Log("creating two strings, try to contatenate them with operator+ and output the result...");
	String Hello = "Hello,";
	AuroraFW::Debug::Log("concatenation process...");
	String HelloWorld = Hello + World;
	CLI::Output << HelloWorld << CLI::EndLine;
	CLI::Output << HelloWorld.length() << CLI::EndLine;
	AuroraFW::Debug::Log("done.");
	AuroraFW::Debug::Log("creating two wide strings, try to contatenate them with operator+ and output the result...");
	...
	*/
	AuroraFW::Debug::Log("creating a string and try to use +=operator with a char pointer and output the result...");
	...
	*/
	AuroraFW::Debug::Log("creating a string and try to use +=operator with another string and output the result...");
	...
	AuroraFW::Debug::Log("creating two strings and try to use conditional ==operator with another string and output the result...");
	...
	CLI::Log(CLI::Information, "the result need to be true");
	CLI::Output << checkEq << CLI::EndLine;
	AuroraFW::Debug::Log("try to use conditional !=operator and output the result...");
	checkEq = Check1Eq != Check2Eq;
	CLI::Log(CLI::Information, "the result need to be false");
	CLI::Output << checkEq << CLI::EndLine;
	AuroraFW::Debug::Log("done.");

	AuroraFW::Debug::Log("try to find a string inside an another string");
	...
	AuroraFW::Debug::Log("try to find an array of chars inside a string");
	String findStr2 = "World Hello!";
	CLI::Log(CLI::Information, "the result need to be 6");
	CLI::Output << findStr2.find("Hello", 0) << CLI::EndLine;

	AuroraFW::Debug::Log("try to find an array of chars inside a string with a specific counter");
	...
	AuroraFW::Debug::Log("testing operator>> and output the input...");
	CLI::Log(CLI::Information, "You need to input something in the shell...");
	String inputstr;
	CLI::Input >> inputstr;
	AuroraFW::Debug::Log("reading input...");
